def calcular_range (elfo_one, elfo_two):
    return int(elfo_one[0]) <= int(elfo_two[0]) <= int(elfo_one[1]) or int(elfo_one[0]) <= int(elfo_two[1]) <= int(elfo_one[1]) \
    or int(elfo_two[0]) <= int(elfo_one[0]) <= int(elfo_two[1]) or int(elfo_two[0]) <= int(elfo_one[1]) <= int(elfo_two[1])
